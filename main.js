window.addEventListener("scroll", function () {
  ...
  const portoSection = document.querySelector(".portfolio");
  ...
  const portoPosition = portoSection.getBoundingClientRect().top + window.scrollY;
  const scrollPosition = window.scrollY;

  if (scrollPosition >= portoPosition) {
    // Bagian portfolio - navbar berubah putih
